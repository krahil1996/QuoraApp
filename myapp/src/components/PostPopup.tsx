            ...
            <div className="flex flex-row w-auto">
              <div className="bg-white w-auto ">
                ...
                <div className="flex flex-row justify-evenly">
                  <div onClick={() => setIsClicked(true)} className={`text-center cursor-pointer font-semibold text-lg p-2 border-b-1 w-1/2 ${isclicked ? "border-b-4 border-blue-600 transition-all ease-in-out rounded-t-2xl" : "border-b-1"}`}>
                    <h2 >Add Question</h2>
                  </div>
                  <div onClick={() => setIsClicked(true)} className={`text-center cursor-pointer font-semibold text-lg p-2 border-b-1 w-1/2 ${isclicked ? "border-b-4 border-blue-600 transition-all ease-in-out rounded-t-2xl" : "border-b-1"}`}>
                    <h2 >Create Post</h2>
                ...
                <div className="sm:items-start sm:p-4">
                  <div>
                    <input
                      ...
                      className={`w-full outline-none h-30 p-2 border-b-1 border-gray-300 ${isHovered ? "border-blue-500" : "border-gray-300"}`}
